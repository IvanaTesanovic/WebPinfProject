		...
		<div class="loginFormWrapper">
			<form name="form" id="loginForm" method="post" action="j_spring_security_check" class="css-form data-ng-dirty data-ng-invalid data-ng-invalid-required mediators-search-form" novalidate>
				...
				<div>
					<fieldset>
			        	...
			        	<div class="row rvr_bottom_padding">
					        <div class="form-group">
						        ...
						        <div class="col6">
						            <input id="j_username" class="form-control" style="width:20em" type="text" name="j_username" data-ng-model="user.username" data-ng-maxlength="50" required>
			        	...
			        	<div class="row rvr_bottom_padding">
					        <div class="form-group">
						        ...
						        <div class="col6">
						            <input id="j_password" class="form-control" style="width:20em" type="password" name="j_password" data-ng-model="user.password" data-ng-maxlength="30" required>
					...
					<br>
					<div>
						<button id="submit_button" class="btn btn-primary" type="submit" name="submit" data-ng-disabled="form.$invalid">
