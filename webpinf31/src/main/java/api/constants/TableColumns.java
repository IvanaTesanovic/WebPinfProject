...
public final class TableColumns {
	...
	public static ArrayList<Column> getColumns(String tableName) {
		...
		case "naseljenaMesta":
			columns.addAll(Arrays.asList(new Column("id", "int"), new Column("naziv", "string"), 
					new Column("ptt_oznaka", "string"), new Column("sifra_drzave", "string")));
			break;
		case "banke":
			columns.addAll(Arrays.asList(new Column("id", "string"), new Column("naziv", "string"),new Column("pib", "string"),
					new Column("sifra_banke", "string"),
					new Column("adresa", "string"), new Column("email", "string"), new Column("telefon", "string"),
					new Column("fax", "string"),new Column("web", "string"), new Column("narodna_banka", "string")));
			break;
		
		case "klijenti":
			columns.addAll(Arrays.asList(new Column("id", "int"),new Column("fizicko_lice", "boolean"),new Column("jmbg", "string"),new Column("ime", "string"),
					new Column("prezime", "string"), new Column("adresa", "string"),new Column("telefon", "string"),new Column("email", "string"),
					new Column("naziv", "string"), new Column("pib", "string"), new Column("fax", "string"), new Column("sajt", "string"),
					new Column("sifra_delatnosti", "string"), new Column("naziv_delatnosti", "string"),new Column("odgovorno_lice", "string")));
			break;
			
		case "racuni":
			columns.addAll(Arrays.asList(new Column("id_banke", "int"),new Column("id_klijenta", "int"),new Column("id_valute", "int"),new Column("id","int"),
					new Column("broj_racuna","string"),new Column("datum_otvaranja","date"), new Column("vazeci","boolean")));
		break;
		
		case "rtgs":
			columns.addAll(Arrays.asList(new Column("id", "int"),new Column("id_analitike_izvoda", "int"),new Column("id_poruke", "string"),new Column("swift_banke_duznika", "string"),
					...
					new Column("datum_naloga", "date"),new Column("sifra_valute", "string"),new Column("datum_valute", "date"),new Column("ukupan_iznos", "double")));
			break;
		case "kliring":
			columns.addAll(Arrays.asList(new Column("id", "int"), new Column("id_poruke", "string"),new Column("id_grupe_izvoda", "int"),
					...
					new Column("swift_banke_poverioca", "string"),new Column("datum_naloga", "date"), new Column("sifra_valute", "string"),new Column("datum_valute", "date"),
		...
		case "analitikeIzvoda":
			columns.addAll(Arrays.asList(new Column("id","int"), new Column("id_dnevnog_stanja_racuna","int"),new Column("id_naseljenog_mesta","int"),
					new Column("id_valute","int"), new Column("it_vrste_placanja","int"),
