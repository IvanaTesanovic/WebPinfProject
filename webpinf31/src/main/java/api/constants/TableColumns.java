...
public final class TableColumns {
	...
	public static ArrayList<Column> getColumns(String tableName) {
		...
		case "kliring":
			...
			break;
		case "kursnaLista":
			columns.addAll(Arrays.asList(new Column("id", "int"),new Column("id_banke","int"), new Column("broj_kursne_liste", "Integer"), new Column("datum", "date"),new Column("datum_primene", "date")));
			break;
			
		case "kursevi":
			columns.addAll(Arrays.asList(new Column("id", "int"),new Column("id_kursne_liste", "int"),
					new Column("id_osnovne_valute", "int"),new Column("id_valute", "int"),
